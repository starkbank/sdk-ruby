...
module StarkBank
  ...
  # - fee [integer, default nil]: fee charged when DAS payment is created. ex: 200 (= R$ 2.00)
  # - created [DateTime, default nil]: creation datetime for the payment. ex: DateTime.new(2020, 3, 10, 10, 30, 0, 0)
  class DasPayment < StarkBank::Utils::Resource
    ...
    #
    # ## Return:
    # - generator of DasPayment objects with updated attributes
