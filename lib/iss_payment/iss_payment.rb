...
module StarkBank
  ...
  # - fee [integer, default nil]: fee charged when ISS payment is created. ex: 200 (= R$ 2.00)
  # - created [DateTime, default nil]: creation datetime for the payment. ex: DateTime.new(2020, 3, 10, 10, 30, 0, 0)
  class IssPayment < StarkBank::Utils::Resource
    ...
    #
    # ## Return:
    # - generator of IssPayment objects with updated attributes
