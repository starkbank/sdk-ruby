...
module StarkBank
  class IssPayment
    ...
    class Log < StarkBank::Utils::Resource
      ...
      # - payment_ids [list of strings, default nil]: list of IssPayment ids to filter retrieved objects. ex: ['5656565656565656', '4545454545454545']
      ...
      def self.resource
        payment_maker = StarkBank::IssPayment.resource[:resource_maker]
        {
          resource_name: 'IssPaymentLog',
