...
describe(StarkBank::MerchantCard::Log, '#merchant-card/log#') do
  it 'query logs' do
    logs = StarkBank::MerchantCard::Log.query(limit: 3).to_a

    logs.each do |log|
      expect(log.id).wont_be_nil
      expect(log.card.id).wont_be_nil
    end
  end
  ...
  it 'query params' do
    log = StarkBank::MerchantCard::Log.query(
      limit: 1,
      after: '2022-01-01',
      before: '2022-01-02',
      types: ['created'],
  ...
  it 'page params' do
    log = StarkBank::MerchantCard::Log.page(
      limit: 1,
      after: '2022-01-01',
      before: '2022-01-02',
      types: ['created'],
